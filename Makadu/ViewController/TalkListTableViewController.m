...
- (IBAction)tapDownload:(id)sender {
    ...
    if([Connection existConnection]) {
        ...
        if(talk.file) {
            ...
            [[[UIAlertView alloc] initWithTitle:nil message:[NSString stringWithFormat:@"O material será enviado para %@ quando disponível", [PFUser currentUser].email] delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil] show];
